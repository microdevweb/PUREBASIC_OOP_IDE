...
Procedure NewSource(FileName$, ExecuteTool)
  *OldSource = *ActiveSource
  ...
  If ExecuteTool
    ...
    UpdateCursorPosition()
  ElseIf FileName$ = ""
    ; Add standard PureBasic OOP starter template
    Template$ = "; ============================================================================" + #NewLine
    Template$ + "; PureBasic OOP Source File (.pbo)" + #NewLine
    Template$ + "; ============================================================================" + #NewLine + #NewLine
    Template$ + "Class MyObject" + #NewLine
    Template$ + "  Public Method SayHello()" + #NewLine
    Template$ + "    PrintN(" + Chr(34) + "Hello from PureBasic OOP!" + Chr(34) + ")" + #NewLine
    Template$ + "  EndMethod" + #NewLine
    Template$ + "EndClass" + #NewLine
    
    *utf8 = UTF8(Template$)
    If *utf8
      SendEditorMessage(#SCI_SETTEXT, 0, *utf8)
      FreeMemory(*utf8)
    EndIf
